  ...
  return (
    <div id="features-container">
      ...
      <div id="features-categories">
        <div
          className={`features-category ${activeCategory === "Bookmark in one click" ? "features-category-active" : ""}`}
          onClick={() => setActiveCategory("Bookmark in one click")}
        >
          Simple Bookmarking
        </div>
        <div
          className={`features-category ${activeCategory === "Intelligent search" ? "features-category-active" : ""}`}
          onClick={() => setActiveCategory("Intelligent search")}
        >
          Speedy Searching
        </div>
        <div
          className={`features-category ${activeCategory === "Share your bookmarks" ? "features-category-active" : ""}`}
      ...
      <div id="feature-categories-container">{featureList}</div>
    </div>
  );
}
